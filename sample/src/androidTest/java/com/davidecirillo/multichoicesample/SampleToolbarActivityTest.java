...
public class SampleToolbarActivityTest {
    ...
    /**
     * Method to check if an item is selected by checkinf the style
     * <p>
     * **important** this method should only be used in this activity because each sample has a specific selection customisation
     *
     * @return true if the item is selected for SampleToolbarActivity customisation specs
     */
    private Matcher<View> isSelected() {
    ...
    private Matcher<View> areAllSelected() {
        return new TypeSafeMatcher<View>() {
