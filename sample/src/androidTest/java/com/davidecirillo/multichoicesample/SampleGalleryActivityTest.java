...
public class SampleGalleryActivityTest extends BaseMultiChoiceActivityTest {
    ...
    protected boolean isSelected(View view) {
        ImageView tickImage = (ImageView) view.findViewById(R.id.tick_image);

        return tickImage != null
                && tickImage.getVisibility() == View.VISIBLE;
    }
}
